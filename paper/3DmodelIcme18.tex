...
% Single address.
% ---------------
\name{Zhehan Song, Xuejin Chen, Zichen Gu, Wei Hu}
\address{ 
...
%
In this paper, we propose a hybrid system which integrates a global camera parameter estimation and 3D model registration instead of the traditional pairwise framework, to produce high quality 3D models.
